...
<html lang="en">
    ...
    <body>
        ...
        <ul class="nav nav-tabs nav-fill bg-dark">
            <li class="nav-item"><a class="nav-link link-light" href="">Jelajah</a></li>
            <li class="nav-item"><a class="nav-link link-light" href="#keranjang" onclick="$('#keranjang').delay(100).fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100)">Keranjang Anda <span class="badge bg-secondary">{{ Auth::user()->cart->count() }}</span></a></li>
            <li class="nav-item"><a class="nav-link link-light" href="">Pesanan Anda</a></li>
        </ul>
